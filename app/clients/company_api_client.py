...
async def search_companies_by_okved(okved_code: str, page: int = 1):
    ...
    print("CHECKO PAGE:", page)
    print("CHECKO PARAMS:", params)
...
async def sync_companies(okved_code: str, session: AsyncSession,  page: int = 1,):
    ...
    for raw_company in data["data"]["Записи"]:
        ...
        await save_company_if_not_exists(session, company_data)
